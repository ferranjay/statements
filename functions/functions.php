...
// 1.   IP ADRES OPHALEN KLANT
// 2.   WINKELWAGEN
// 3.   TOTAAL AANTAL ITEMS IN WINKELWAGEN
// 4.   OPHALEN VAN TOTALE PRIJS
// 5.   UPDATEN WINKELWAGEN
// 6.   OPHALEN CATEGORIEN
// 7.   OPHALEN BRANDS
// 8.   FUNCTIE INDIEN GEEN CLICK OP CAT OF BRANDS
// 9.   FUNCTIE VOOR SPECIFIEK GESELECTEERDE CATEGORIE
// 10.  FUNCTIE VOOR SPECIFIEK GESELECTEERDE BRANDS


$db_connection = mysqli_connect ("192.168.64.2", "root", "", "webshop01");  
...
// 1. 
// HET IP ADRES HAAL IK OP MET DE CODE HIERONDER
...
// 3. OPHALEN TOTAAL AANTAL ITEMS IN WINKELWAGEN 

function total_items() {

    if(isset($_GET['add_cart'])){   // determine if a variable is set 
...
//  4. OPHALEN VAN TOTALE PRIJS MET WHILE LOOP   DIT MOET VERVANGEN WORDEN MET foreach
